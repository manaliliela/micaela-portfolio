...
// order shown on the site (strongest first). Each visual is placed by
...
export const PROJECTS = [
  {
    ...
    role: "Instagram feed content, promotions and giveaway posts for a Dubai travel company.",
  ...
  },
  {
    ...
    role: "Website and social media content for a dental practice.",
    ratio: "16 / 10",
    items: [
      { kind: "browser", src: "/work/dr-lim-dental/dr-lim-cover.png", w: 1888, h: 831, alt: "Dr. Lim Dental website", pos: { left: 3, top: 6, width: 72, rot: 0, z: 1 } },
      { kind: "card", src: "/work/dr-lim-dental/dr-lim-sample-1.png", w: 616, h: 617, alt: "Dr. Lim Dental social post: Can't handle the tooth?", pos: { left: 55, top: 38, width: 40, rot: 3, z: 3 } },
      { kind: "card", src: "/work/dr-lim-dental/dr-lim-sample.png", w: 329, h: 441, alt: "Dr. Lim Dental Instagram post collection", pos: { left: 6, top: 47, width: 26, rot: -4, z: 2 } },
    ],
  },
  {
    slug: "gobro",
    ...
    role: "Social media and marketing content for a web services company.",
    ratio: "1 / 1",
    items: [
  ...
  },
  {
    ...
    role: "Website content and operations support.",
    ratio: "5 / 4",
    items: [
      { kind: "browser", src: "/work/masshouse/masshouse-sample.png", w: 1852, h: 929, alt: "MassHouse website news page", pos: { left: 2, top: 3, width: 96, rot: 0, z: 1 } },
      { kind: "card", src: "/work/masshouse/masshouse-cover.png", w: 376, h: 245, alt: "MassHouse logo", pos: { left: 8, top: 48, width: 40, rot: -4, z: 2 } },
    ],
  },
  {
    slug: "sushiboy",
    ...
    role: "Social media graphics for a food brand.",
    ratio: "5 / 4",
    items: [
  ...
  },
  {
    ...
    role: "Instagram content for a coatings company.",
    ratio: "5 / 4",
    items: [
...
// Additional projects: presentations & company profiles.
...
export const ADDITIONAL = [
  ...
  {
    id: "tripgo",
    title: "Tripgo Travel Agency",
    note: "Company profile",
    tone: "pink",
    images: [
      { src: "/work/additional-projects/project-1.png", w: 1692, h: 277, alt: "Tripgo Travel Agency company profile slides" },
      { src: "/work/additional-projects/project-2.png", w: 1201, h: 341, alt: "Tripgo Travel Agency company profile, inner pages" },
    ],
  },
  {
    id: "fitdxb",
