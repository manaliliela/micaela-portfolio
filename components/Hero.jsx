      ...
      >
        ...
        <div className="heroCopy">
          <h1 id="hero-title" className="heroTitle">
            <MaskLine delay={0.5}>Reliable <span className="accentScript">Support</span></MaskLine>
            <MaskLine delay={0.64}>Behind the Scenes</MaskLine>
          </h1>

          <motion.p className="heroText" initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.05, duration: 0.8, ease: EASE }}>
          ...
          <motion.div className="heroButtons" initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 1.25, duration: 0.8, ease: EASE }}>
