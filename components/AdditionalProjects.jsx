...
export default function AdditionalProjects() {
  ...
  // and from the last project it cycles back to the first.
  const onCardClick = (e) => {
      ...
      <Reveal from="scale">
        ...
        >
          <div className="carStage">
            <button type="button" className="carArrow carArrowLeft" onClick={() => go(index - 1)} disabled={index === 0} aria-label="Previous project">
              <Arrow dir="prev" />
            </button>
            ...
            <button type="button" className="carArrow carArrowRight" onClick={() => go(index + 1)} disabled={index === count - 1} aria-label="Next project">
              <Arrow dir="next" />
            </button>
          </div>
