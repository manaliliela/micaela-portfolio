...
export default function Header() {
  ...
  return (
    <>
      <motion.div className="topBar" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.6 }}>
      ...
      >
        <div className="headerInner">
          <a href="#top" className="brand" aria-label="Simply Micaela — back to top">
            <Image
              src="/logo/micaela-logo-header.png"
              alt="Simply Micaela logo"
              width={520}
              height={493}
              priority
              sizes="80px"
